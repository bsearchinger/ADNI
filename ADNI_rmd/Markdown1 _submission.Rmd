...
```{r radtools-install, message=FALSE, warning=FALSE}
# Install Package
source("https://neuroconductor.org/neurocLite.R")
neuro_install('radtools', release = "stable", release_repo = "github")
```

```{r radtools-read, results='hold', message=FALSE, warning=FALSE}
library(radtools)
...
```{r header-info, message=FALSE, warning=FALSE}
...
```{r header-info-slices, message=FALSE, warning=FALSE}
dicom_head[1:10, 5:7]
```
